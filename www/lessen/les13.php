...
<nav>
    ...
    <section class="container">
        ...
        <div class="features">
            <div class="card">
                <span><?php echo $lessen[12][1] ?> <br></span>
                <h4><?php echo $lessen[12][11] ?></h4>
                <p>
                
                    
                    <?php echo $lessen[12][2] ?> <br>
                    <?php echo $lessen[12][3] ?> <br>
                    <?php echo $lessen[12][4] ?> <br>
                    <?php echo $lessen[12][5] ?> <br>
                    <?php echo $lessen[12][6] ?> <br>
                    <?php echo $lessen[12][7] ?> <br>
                    <?php echo $lessen[12][8] ?> <br>
                    <?php echo $lessen[12][9] ?> <br>
                    <?php echo $lessen[12][10] ?> <br>
