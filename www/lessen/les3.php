...
<nav>
    ...
    <section class="container">
        ...
        <div class="features">
            <div class="card">
                <span><?php echo $lessen[2][1] ?> <br></span>
                <h4><?php echo $lessen[2][11] ?></h4>
                <p>
                
                    
                    <?php echo $lessen[2][2] ?> <br>
                    <?php echo $lessen[2][3] ?> <br>
                    <?php echo $lessen[2][4] ?> <br>
                    <?php echo $lessen[2][5] ?> <br>
                    <?php echo $lessen[2][6] ?> <br>
                    <?php echo $lessen[2][7] ?> <br>
                    <?php echo $lessen[2][8] ?> <br>
                    <?php echo $lessen[2][9] ?> <br>
                    <?php echo $lessen[2][10] ?> <br>
