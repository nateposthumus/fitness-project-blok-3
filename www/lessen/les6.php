...
<nav>
    ...
    <section class="container">
        ...
        <div class="features">
            <div class="card">
                <span><?php echo $lessen[5][1] ?> <br></span>
                <h4><?php echo $lessen[5][11] ?></h4>
                <p>
                
                    
                    <?php echo $lessen[5][2] ?> <br>
                    <?php echo $lessen[5][3] ?> <br>
                    <?php echo $lessen[5][4] ?> <br>
                    <?php echo $lessen[5][5] ?> <br>
                    <?php echo $lessen[5][6] ?> <br>
                    <?php echo $lessen[5][7] ?> <br>
                    <?php echo $lessen[5][8] ?> <br>
                    <?php echo $lessen[5][9] ?> <br>
                    <?php echo $lessen[5][10] ?> <br>
