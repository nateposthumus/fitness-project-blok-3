...
<nav>
    ...
    <section class="container">
        ...
        <div class="features">
            <div class="card">
                <span><?php echo $lessen[14][1] ?> <br></span>
                <h4><?php echo $lessen[14][11] ?></h4>
                <p>
                
                    
                    <?php echo $lessen[14][2] ?> <br>
                    <?php echo $lessen[14][3] ?> <br>
                    <?php echo $lessen[14][4] ?> <br>
                    <?php echo $lessen[14][5] ?> <br>
                    <?php echo $lessen[14][6] ?> <br>
                    <?php echo $lessen[14][7] ?> <br>
                    <?php echo $lessen[14][8] ?> <br>
                    <?php echo $lessen[14][9] ?> <br>
                    <?php echo $lessen[14][10] ?> <br>
