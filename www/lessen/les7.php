...
<nav>
    ...
    <section class="container">
        ...
        <div class="features">
            <div class="card">
                <span><?php echo $lessen[6][1] ?> <br></span>
                <h4><?php echo $lessen[6][11] ?></h4>
                <p>
                
                    
                    <?php echo $lessen[6][2] ?> <br>
                    <?php echo $lessen[6][3] ?> <br>
                    <?php echo $lessen[6][4] ?> <br>
                    <?php echo $lessen[6][5] ?> <br>
                    <?php echo $lessen[6][6] ?> <br>
                    <?php echo $lessen[6][7] ?> <br>
                    <?php echo $lessen[6][8] ?> <br>
                    <?php echo $lessen[6][9] ?> <br>
                    <?php echo $lessen[6][10] ?> <br>
