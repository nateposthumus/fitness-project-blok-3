...
<nav>
    ...
    <section class="container">
        ...
        <div class="features">
            <div class="card">
                <span><?php echo $lessen[9][1] ?> <br></span>
                <h4><?php echo $lessen[9][11] ?></h4>
                <p>
                
                    
                    <?php echo $lessen[9][2] ?> <br>
                    <?php echo $lessen[9][3] ?> <br>
                    <?php echo $lessen[9][4] ?> <br>
                    <?php echo $lessen[9][5] ?> <br>
                    <?php echo $lessen[9][6] ?> <br>
                    <?php echo $lessen[9][7] ?> <br>
                    <?php echo $lessen[9][8] ?> <br>
                    <?php echo $lessen[9][9] ?> <br>
                    <?php echo $lessen[9][10] ?> <br>
