...
<nav>
    ...
    <section class="container">
        ...
        <div class="features">
            <div class="card">
                <span><?php echo $lessen[4][1] ?> <br></span>
                <h4><?php echo $lessen[4][11] ?></h4>
                <p>
                
                    
                    <?php echo $lessen[4][2] ?> <br>
                    <?php echo $lessen[4][3] ?> <br>
                    <?php echo $lessen[4][4] ?> <br>
                    <?php echo $lessen[4][5] ?> <br>
                    <?php echo $lessen[4][6] ?> <br>
                    <?php echo $lessen[4][7] ?> <br>
                    <?php echo $lessen[4][8] ?> <br>
                    <?php echo $lessen[4][9] ?> <br>
                    <?php echo $lessen[4][10] ?> <br>
